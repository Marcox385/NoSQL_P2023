...
def list_books(rating=0, pages='', ratings_count='', title='', limit=0, skip=0):
    suffix = "/book"
    ...
    if response.ok:
        ...
        if (json_resp):
            ...
            print('No books found with given parameters!')
    else:
...
def main():
    ...
    parser.add_argument("action", choices=list_of_actions,
            help="Action to be used for the books library")
    ...
    parser.add_argument("-p", "--pages",
            help="Provide a number of page search parameter (comparison operators supported)", default=None)
    parser.add_argument("-rc", "--ratings-count",
            help="Provide a ratings count search parameter (comparison operators supported)", default=None)
    parser.add_argument("-t", "--title",
            help="Provide a title search parameter (behaves as LIKE operator); Wrap search term between quotes for multiple words", default=None)
    parser.add_argument("-l", "--limit",
            help="Limit results length with given boundary", default=None)
    parser.add_argument("-s", "--skip",
            help="Skip given number of results", default=None)
